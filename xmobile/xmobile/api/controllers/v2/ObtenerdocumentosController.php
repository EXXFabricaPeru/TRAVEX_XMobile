...
class ObtenerdocumentosController extends ActiveController {
	...
	public function actionIndex(){
        //no se usa este end poind 
        Yii::error("Datos Ingreso: ".json_encode($app->request->post()));
        ...
        */
        ...
        foreach ($cabecera as $key => $value) {
            ...
            if(isset($cabeceradocumentos['estado'])){
                if($cabeceradocumentos['eliminado'] && $cabeceradocumentos['eliminado']==3){
                    $cabecera[0]->canceled="3";
                }
