...
class ProductoslotesController extends ActiveController {
    use Respuestas;
    ...
    public function actionIndex(){
        ...
        $modelo= $modelo->obtenerProductosLotes($equipo,$usuario,$salto);
        if (count($modelo)){
    ...
    public function actionContador(){
        ...
        $usuario=Yii::$app->request->post('usuario');        
        $modelo=new Productos;
        $modelo= $modelo->obtenerProductosLotesContador($equipo);
    ...
    public function actionBuscador(){
        ...
        $modelo=new Productos;
        $modelo= $modelo->obtenerProductosLotesTodos($equipo,$usuario,$texto,$almacen,$lote);
        return $this->correcto($modelo, 'OK'); 
    }
}