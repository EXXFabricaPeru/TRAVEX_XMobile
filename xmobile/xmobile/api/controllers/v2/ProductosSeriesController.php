...
class ProductosseriesController extends ActiveController {
    use Respuestas;
    ...
    public function actionIndex(){
        ...
        $modelo= $modelo->obtenerProductosSeries($equipo,$usuario,$salto);
        if (count($modelo)){
    ...
    public function actionContador(){
        ...
        $usuario=Yii::$app->request->post('usuario');        
        $modelo=new Productos;
        $modelo= $modelo->obtenerProductosSeriesContador($equipo);
    ...
    public function actionBuscador(){
        ...
        $modelo=new Productos;
        $modelo= $modelo->obtenerProductosSeriesTodos($equipo,$usuario,$texto,$almacen,$serie);
        return $this->correcto($modelo, 'OK'); 
    }
}