...
use backend\models\v2\Gestionsap;

class GestionsapController extends ActiveController {
    ...
    public function actionIndex() {
        $respuesta = Yii::$app->db->createCommand('select * from gestionsap')                
                ->queryAll();        
        if (count($respuesta)){
    ...
    public function actionCreate() {
        ...
        $modelo=new Gestionsap;
        $modelo= $modelo->obtenerGestionSap($equipo,$usuario,$salto);
    ...
    public function actionContador(){
       ...
       $modelo=new Gestionsap;
       $modelo= $modelo->obtenerGestionSapContador();
       return $this->correcto($modelo, 'OK');
    }
}
