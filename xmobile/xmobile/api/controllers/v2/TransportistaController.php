...
use backend\models\v2\Transportista;

class TransportistaController extends ActiveController {
    ...
    public function actionCreate() {
        ...
        $modelo=new Transportista;
        $modelo= $modelo->obtenerTransportista($equipo,$usuario,$salto);
    ...
    public function actionContador(){
       ...
       $modelo=new Transportista;
       $modelo= $modelo->obtenerTransportistaContador();
       return $this->correcto($modelo, 'OK');
    }
}
