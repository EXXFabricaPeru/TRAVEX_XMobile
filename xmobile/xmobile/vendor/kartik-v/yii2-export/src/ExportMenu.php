...
class ExportMenu extends GridView
{
    ...
    protected function setDefaultExportConfig()
    {
        ...
        /*
            self::FORMAT_PDF => [
                ...
                'alertMsg' => Yii::t('kvexport', 'El archivo PDF se descargara automáticamente.'),
           ...
           */
            self::FORMAT_EXCEL_X => [
                ...
                'alertMsg' => Yii::t('kvexport', 'El archivo EXCEL se descargara automáticamente.'),
    ...
    protected function registerAssets()
    {
        ...
        $this->messages += [
            ...
            'confirmDownload' => Yii::t('kvexport', ''),//ok para continuar
