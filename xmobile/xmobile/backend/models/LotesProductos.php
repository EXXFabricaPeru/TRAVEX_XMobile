...
/**
 * This is the model class for table "lotesproductos".
 *
 ...
 */
class LotesProductos extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['ItemCode', 'BatchNum', 'WhsCode', 'ItemName', 'SuppSerial', 'IntrSerial',
            'ExpDate', 'PrdDate', 'InDate', 'Located', 'Notes', 'Quantity', 'BaseType',
            'BaseEntry', 'BaseNum', 'BaseLinNum', 'CardCode', 'CardName', 'CreateDate',
            'Status', 'Direction', 'IsCommited', 'OnOrder', 'Consig', 'DataSource',
            'UserSign', 'Transfered', 'Instance', 'SysNumber', 'LogInstanc', 'UserSign2',
            'UpdateDate'], 'string', 'max' => 255]
        ];
    }
