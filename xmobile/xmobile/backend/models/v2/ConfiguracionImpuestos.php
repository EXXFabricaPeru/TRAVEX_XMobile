...
class Configuracionimpuestos extends Model{
    private $hana;
    public function __construct() {
        $this->hana=New hana;
    }
    public function obtenerConfiguracionImpuestosContador(){        
    ...
    public function obtenerConfiguracionImpuestos($equipo,$usuario,$salto=0,$limite=1000){
        if($salto==""){
            $salto=0;
        }
        if($limite==""){
