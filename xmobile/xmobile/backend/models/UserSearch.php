...
class UserSearch extends User
{
    ...
    public function rules()
    {
        return [
            ...
            [['username', 'auth_key', 'password_hash', 'password_reset_token', 'verification_token', 'access_token', 'fechaUMUsuario', 'plataformaUsuario', 'plataformaPlataforma', 'plataformaEmei','regional'], 'safe'],
        ];
    }
