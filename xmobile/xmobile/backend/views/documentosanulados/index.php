...
$this->title = 'Viobtienedocumentosanulados';
?>
...
<div class="viobtienedocumentosanulados-index">

<p class="text-right"> <button class="btn btn-success" id="btn-create">'Crear Viobtienedocumentosanulados' </button>
    </p>
    <?= GridView::widget([
...
<?=  $this->registerJsFile(Yii::getAlias('@web') . '/scripts/Viobtienedocumentosanulados/Main.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?> 
