...
class Viobtienedocumentosanulados {
    public setting: any;
    public Objet: any;
    ...
    constructor() {
        ...
        this.Objet = Object;
        this.elementGrid = "#Viobtienedocumentosanulados-list";
    ...
    public windowCreate() {
        ...
        let option = {
            ...
            open: () => {
                this.element.load(this.url + 'viobtienedocumentosanulados/create');
            },
            buttons: [{
                text: "REGISTRAR",
                class: "btn btn-success",
                click: async () => {
                    let data = $('#Viobtienedocumentosanulados-form').serialize();
    ...
    public windowEdit(id: any) {
        ...
        let option = {
            ...
            open: () => {
                this.element.load(this.url + 'viobtienedocumentosanulados/update&id=' + id);
            },
            buttons: [{
                text: "GUARDAR",
                class: "btn btn-success",
    ...
    public windowPdf(id: any) {
        let url = this.url + 'viobtienedocumentosanulados/report&id=' + id;
        $("#windowpdf").dialog({
    ...
    private requestPut(id: any, data: any) {
        return new Promise((resolve, reject) => {
            $.ajax({
                url: this.url + 'viobtienedocumentosanulados/update&id=' + id,
                type: 'PUT',
                data: data,
    ...
    private requestDelete(data: any) {
        return new Promise((resolve, reject) => {
            $.get(this.url + 'viobtienedocumentosanulados/eliminar&id=' + data).done((data) => {
                resolve(data);
            }).fail((err) => {
                reject(err);
            });
    ...
    private requestPost(data: any) {
        return new Promise((resolve, reject) => {
            $.ajax({
                url: this.url + 'viobtienedocumentosanulados/create',
                type: 'POST',
                data: data,
                success: (data, status, xhr) => {
                    resolve(JSON.parse(data));
...
$(() => {
    let model = new Viobtienedocumentosanulados();
    $("#btn-create").on('click', () => {
        model.windowCreate();
    });
