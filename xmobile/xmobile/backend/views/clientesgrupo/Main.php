...
class Clientesgrupo {
    ...
    constructor() {
        ...
        this.Objet = Object;
        this.elementGrid = "#Clientesgrupo-list";
    ...
    public windowCreate() {
        ...
        let option = {
            ...
            open: () => {
                this.element.load(this.url + 'clientesgrupo/create');
            },
            buttons: [{
                text: "REGISTRAR",
                class: "btn btn-success",
                click: async () => {
                    let data = $('#Clientesgrupo-form').serialize();
    ...
    public windowEdit(id: any) {
        ...
        let option = {
            ...
            open: () => {
                this.element.load(this.url + 'clientesgrupo/update&id=' + id);
            },
            buttons: [{
                text: "GUARDAR",
                class: "btn btn-success",
    ...
    public windowPdf(id: any) {
        let url = this.url + 'clientesgrupo/report&id=' + id;
        $("#windowpdf").dialog({
    ...
    private requestPut(id: any, data: any) {
        return new Promise((resolve, reject) => {
            $.ajax({
                url: this.url + 'clientesgrupo/update&id=' + id,
                type: 'PUT',
                data: data,
    ...
    private requestDelete(data: any) {
        return new Promise((resolve, reject) => {
            $.get(this.url + 'clientesgrupo/eliminar&id=' + data).done((data) => {
                resolve(data);
            }).fail((err) => {
                reject(err);
            });
    ...
    private requestPost(data: any) {
        return new Promise((resolve, reject) => {
            $.ajax({
                url: this.url + 'clientesgrupo/create',
                type: 'POST',
                data: data,
                success: (data, status, xhr) => {
                    resolve(JSON.parse(data));
