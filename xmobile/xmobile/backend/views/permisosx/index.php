...
use yii\widgets\Pjax;$this->title = 'Permisosxes';
?>
...
<div class="permisosx-index">

<p class="text-right"> <button class="btn btn-success" id="btn-create">'Crear Permisosx' </button>
    </p>
<?php Pjax::begin(['id' => 'Permisosx-list']); ?>
    <?= GridView::widget([
...
<?=  $this->registerJsFile(Yii::getAlias('@web') . '/scripts/Permisosx/Main.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?> 
