...
use yii\widgets\Pjax;$this->title = 'Monedas';
?>
...
<p class="text-right"> <button class="btn btn-success" id="btn-create">'Crear Monedas' </button>
    </p>
<?php Pjax::begin(['id' => 'Monedas-list']); ?>
    <?= GridView::widget([
...
<?=  $this->registerJsFile(Yii::getAlias('@web') . '/scripts/Monedas/Main.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?> 
