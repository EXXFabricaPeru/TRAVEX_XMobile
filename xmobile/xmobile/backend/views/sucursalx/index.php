...
<div class="row">
    <div class="col-md-12">
		...
		?>
        <p class="text-right"> <button class="btn btn-success" id="btn-create">Crear Sucursal</button>
        </p>
		<?php
		}
		?>
        <?php Pjax::begin(['id' => 'Sucursalx-list']); ?>
        <?=
        GridView::widget([
...
<?= $this->registerJsFile(Yii::getAlias('@web') . '/scripts/Sucursalx.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?> 
