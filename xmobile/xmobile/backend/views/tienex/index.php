...
use yii\widgets\Pjax;$this->title = 'Tienexes';
?>
...
<div class="tienex-index">

<p class="text-right"> <button class="btn btn-success" id="btn-create">'Crear Tienex' </button>
    </p>
<?php Pjax::begin(['id' => 'Tienex-list']); ?>
    <?= GridView::widget([
...
<?=  $this->registerJsFile(Yii::getAlias('@web') . '/scripts/Tienex/Main.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?> 
