...
class Usuariolog {
    ...
    constructor() {
        ...
        this.Objet = Object;
        this.elementGrid = "#Usuariolog-list";
    ...
    public windowCreate() {
        ...
        let option = {
            ...
            open: () => {
                this.element.load(this.url + 'usuariolog/create');
            },
            buttons: [{
                text: "REGISTRAR",
                class: "btn btn-success",
                click: async () => {
                    let data = $('#Usuariolog-form').serialize();
    ...
    public windowEdit(id: any) {
        ...
        let option = {
            ...
            open: () => {
                this.element.load(this.url + 'usuariolog/update&id=' + id);
            },
            buttons: [{
                text: "GUARDAR",
                class: "btn btn-success",
    ...
    public windowPdf(id: any) {
        let url = this.url + 'usuariolog/report&id=' + id;
        $("#windowpdf").dialog({
    ...
    private requestPut(id: any, data: any) {
        return new Promise((resolve, reject) => {
            $.ajax({
                url: this.url + 'usuariolog/update&id=' + id,
                type: 'PUT',
                data: data,
    ...
    private requestDelete(data: any) {
        return new Promise((resolve, reject) => {
            $.get(this.url + 'usuariolog/eliminar&id=' + data).done((data) => {
                resolve(data);
            }).fail((err) => {
                reject(err);
            });
    ...
    private requestPost(data: any) {
        return new Promise((resolve, reject) => {
            $.ajax({
                url: this.url + 'usuariolog/create',
                type: 'POST',
                data: data,
                success: (data, status, xhr) => {
                    resolve(JSON.parse(data));
