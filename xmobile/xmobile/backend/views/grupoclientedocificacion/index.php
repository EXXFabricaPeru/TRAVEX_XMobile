...
use yii\widgets\Pjax;$this->title = 'Grupoclientedocificacions';
?>
...
<div class="grupoclientedocificacion-index">
	<?php
	if(Yii::$app->session->get('NIVEL')=='2'){
	?>
	<p class="text-right"> <button class="btn btn-success" id="btn-create">Nuevo grupo cliente dosificacion</button>
    </p>
	<?php
	}
	?>
<?php Pjax::begin(['id' => 'Grupoclientedocificacion-list']); ?>
    <?= GridView::widget([
...
<?=  $this->registerJsFile(Yii::getAlias('@web') . '/scripts/Grupoclientedocificacion/Main.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?> 
