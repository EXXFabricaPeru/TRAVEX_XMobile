...
$this->title = 'Usuariosincronizamovils';
?>
...
<div class="usuariosincronizamovil-index">

<!--<p class="text-right"> <button class="btn btn-success" id="btn-create">'Crear Usuariosincronizamovil' </button>
    </p>-->
    <?= GridView::widget([
...
<?=  $this->registerJsFile(Yii::getAlias('@web') . '/scripts/Usuariosincronizamovil/Main.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?> 
