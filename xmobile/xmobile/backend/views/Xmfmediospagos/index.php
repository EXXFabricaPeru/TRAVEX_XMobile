...
<div class="xmfmediospagos-index">

<p class="text-right"> <button class="btn btn-success" id="btn-create">'Crear Xmfmediospagos' </button>
    </p>
    <?= GridView::widget([
...
<?=  $this->registerJsFile(Yii::getAlias('@web') . '/scripts/Xmfmediospagos/Main.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?> 
