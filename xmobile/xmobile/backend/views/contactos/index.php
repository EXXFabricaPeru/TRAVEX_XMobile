...
use yii\widgets\Pjax;$this->title = 'Contactos';
?>
...
<!--p class="text-right"> <button class="btn btn-success" id="btn-create">'Crear Contactos' </button>
    </p-->
<?php Pjax::begin(['id' => 'Contactos-list']); ?>
    <?= GridView::widget([
...
<?=  $this->registerJsFile(Yii::getAlias('@web') . '/scripts/Contactos/Main.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?> 
