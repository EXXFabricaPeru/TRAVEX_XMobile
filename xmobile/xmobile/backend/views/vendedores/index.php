...
use yii\widgets\Pjax;$this->title = 'Vendedores';
?>
...
<p class="text-right"> <button class="btn btn-success" id="btn-create">'Crear Vendedores' </button>
    </p>
<?php Pjax::begin(['id' => 'Vendedores-list']); ?>
    <?= GridView::widget([
...
<?=  $this->registerJsFile(Yii::getAlias('@web') . '/scripts/Vendedores/Main.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?> 
