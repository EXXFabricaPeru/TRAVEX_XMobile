...
use yii\widgets\Pjax;$this->title = 'Productosprecios';
?>
...
<div class="productosprecios-index">

<!--p class="text-right"> <button class="btn btn-success" id="btn-create">'Crear Productosprecios' </button>
    </p-->
<?php Pjax::begin(['id' => 'Productosprecios-list']); ?>
    <?= GridView::widget([
...
<?=  $this->registerJsFile(Yii::getAlias('@web') . '/scripts/Productosprecios/Main.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?> 
