...
$this->title = 'Cabeceradocumentos';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="cabeceradocumentos-index">

    <p>
<?php Html::a('Create Cabeceradocumentos', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
...
<?= $this->registerJsFile(Yii::getAlias('@web') . '/js/documentos.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?> 