...
<div class="row">
    <div class="col-md-12">
		...
		?>
        <?php Pjax::begin(['id' => 'Motivonoventa-list']); ?>
        <?=
        GridView::widget([
...
<?= $this->registerJsFile(Yii::getAlias('@web') . '/scripts/Motivonoventa.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?> 
