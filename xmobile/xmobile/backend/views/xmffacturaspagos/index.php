...
<div class="xmffacturaspagos-index">

<p class="text-right"> <button class="btn btn-success" id="btn-create">'Crear Xmffacturaspagos' </button>
    </p>
    <?= GridView::widget([
...
<?=  $this->registerJsFile(Yii::getAlias('@web') . '/scripts/Xmffacturaspagos/Main.js', ['depends' => [yii\web\JqueryAsset::className()]]); ?> 
