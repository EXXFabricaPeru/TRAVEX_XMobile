...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-6" style="height:500px;overflow:auto;">  
            <div class="row">
                <div class="col-md-5" >
                	<label><h4>Nombre de Ruta: </h4><?=$model->nombreRuta?></label>	
                </div>
                 <div class="col-md-2" >
                	<label><h4>Dia: </h4><?=$model->dia?></label>
                </div>
                 <div class="col-md-5" >
                	<label><h4>Vendedor: </h4><?=$model->vendedor?></label>
                </div>
            </div> 
            ...
            success: function (data) {
                ...
                if(ArrayData.length>=1){
                    for(var i=0;i<ArrayData.length;i++){
                        ...
                        contenido=contenido+ AdicionarRow((i+1),ArrayData[i].cardcode,ArrayData[i].cardname,ArrayData[i].latitud,ArrayData[i].longitud,ArrayData[i].calle,'tableDetalle',ArrayData[i].territoryid,ArrayData[i].poligonoid,i+1,'0',ArrayData[i].territoryname);
    ...
    //alert(tabla);
      //  var items = document.getElementById(tabla);
        ...
        var contenido = '<tr  id="tr-fila-'+idAux+'" title="'+swObservacion+'"  style="'+stylo+'"  onclick="mostrarEtiquetaApi('+idAux+')" >  '+
                    ...
                    '<td style="width:10"> '+territorio+' </td>'+                           

                    '<td style="display: none;" align="center" >  <button title="Eliminar Fila" type="button" class="btn-link" value="" onclick="EliminarFila('+idAux+')" ><i class="fas fa-trash-alt text-warning"></i></button> '+swObservacion+' </td>'+                           
