...
class Lbcc {
    ...
    public onloadViewForm() {
        ...
        $("#lbcc-u_series").change(function () {
            let texto = $(this).children("option:selected").text();
    ...
    public windowCreate() {
        ...
        let option = {
            ...
            open: () => {
                this.element.load(this.url + 'lbcc/create', () => {
                    this.onloadViewForm();
                });
            },
            buttons: [{
    ...
    public windowEdit(id: any) {
        ...
        let option = {
            ...
            open: () => {
                this.element.load(this.url + 'lbcc/update&id=' + id, () => {
                    this.onloadViewForm();
                });
            },
            buttons: [{
    ...
    public windowPdf(id: any) {
        let url = this.url + 'lbcc/report&id=' + id;
        $("#windowpdf").dialog({
    ...
    private requestPut(id: any, data: any) {
        return new Promise((resolve, reject) => {
            $.ajax({
                url: this.url + 'lbcc/update&id=' + id,
                type: 'PUT',
                data: data,
    ...
    private requestDelete(data: any) {
        return new Promise((resolve, reject) => {
            $.get(this.url + 'lbcc/eliminar&id=' + data).done((data) => {
                resolve(data);
            }).fail((err) => {
                reject(err);
            });
