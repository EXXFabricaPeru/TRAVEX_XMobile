...
class Poligonocabecera {
    ...
    public windowCreate() {
        ...
        let option = {
            ...
            open: () => {
                this.element.load(this.url + 'poligonocabecera/create');
            },
            buttons: [{
    ...
    public windowEdit(id: any) {
        ...
        let option = {
            ...
            open: () => {
                this.element.load(this.url + 'poligonocabecera/update&id=' + id);
            },
            buttons: [{
                text: "DIBUJAR POLIGONO",
                class: "btn btn-success",
    ...
    public windowPdf(id: any) {
        let url = this.url + 'poligonocabecera/report&id=' + id;
        $("#windowpdf").dialog({
    ...
    private requestPut(id: any, data: any) {
        return new Promise((resolve, reject) => {
            $.ajax({
                url: this.url + 'poligonocabecera/update&id=' + id,
                type: 'PUT',
                data: data,
    ...
    private requestDelete(data: any) {
        return new Promise((resolve, reject) => {
            $.get(this.url + 'poligonocabecera/eliminar&id=' + data).done((data) => {
                resolve(data);
            }).fail((err) => {
                reject(err);
            });
    ...
    private requestPost(data: any) {
        return new Promise((resolve, reject) => {
            $.ajax({
                url: this.url + 'poligonocabecera/create',
                type: 'POST',
                data: data,
                success: (data, status, xhr) => {
                    resolve(JSON.parse(data));
...
$(() => {
    let model = new Poligonocabecera();
    $("#btn-create").on('click', () => {
        model.windowCreate();
    });
