...
class Acciones {
    ...
    public windowCreate() {
        ...
        let option = {
            ...
            open: () => {
                this.element.load(this.url + 'acciones/create', () => {
                    this.fromaction();
                });
            },
            buttons: [{
                ...
                click: async () => {
                    let data = $('#Acciones-form').serialize();
    ...
    public windowEdit(id: any) {
        ...
        let option = {
            ...
            open: () => {
                this.element.load(this.url + 'acciones/update&id=' + id, () => {
                    this.fromaction();
                });
            },
            buttons: [{
    ...
    public windowPdf(id: any) {
        let url = this.url + 'acciones/report&id=' + id;
        $("#windowpdf").dialog({
    ...
    private requestPut(id: any, data: any) {
        return new Promise((resolve, reject) => {
            $.ajax({
                url: this.url + 'acciones/update&id=' + id,
                type: 'PUT',
                data: data,
    ...
    private requestDelete(data: any) {
        return new Promise((resolve, reject) => {
            $.get(this.url + 'acciones/eliminar&id=' + data).done((data) => {
                resolve(data);
            }).fail((err) => {
                reject(err);
            });
