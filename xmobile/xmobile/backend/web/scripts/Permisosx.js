...
var Permisosx = (function () {
    function Permisosx() {
        this.element = $(".window");
        this.url = $("#PATH").attr("name");
        this.Objet = Object;
        this.elementGrid = "#Permisosx-list";
        this.setting = { width: '80%', height: 500, hide: 'fade', show: 'fade', modal: true };
    }
    Permisosx.prototype.windowCreate = function () {
        var _this = this;
        this.element.html('<div class="loader">Loading...</div>');
        var option = {
            title: 'NUEVO REGISTRO',
            open: function () {
                _this.element.load(_this.url + 'permisosx/create');
            },
            buttons: [{
                    text: "REGISTRAR",
    ...
    Permisosx.prototype.windowEliminar = function (id) {
        var _this = this;
        var obj = {
    ...
    Permisosx.prototype.windowEdit = function (id) {
        var _this = this;
        this.element.html('<div class="loader">Loading...</div>');
        var option = {
            title: 'ACTUALIZAR REGISTRO',
            open: function () {
                _this.element.load(_this.url + 'permisosx/update&id=' + id);
            },
            buttons: [{
                    text: "GUARDAR",
                    class: "btn btn-success",
    ...
    Permisosx.prototype.windowPdf = function (id) {
        var url = this.url + 'permisosx/report&id=' + id;
        $("#windowpdf").dialog({
    ...
    Permisosx.prototype.requestPut = function (id, data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: _this.url + 'permisosx/update&id=' + id,
                type: 'PUT',
                data: data,
    ...
    Permisosx.prototype.requestDelete = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.get(_this.url + 'permisosx/eliminar&id=' + data).done(function (data) {
                resolve(data);
            }).fail(function (err) {
                reject(err);
            });
    ...
    Permisosx.prototype.requestPost = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.ajax({
...
//# sourceMappingURL=Permisosx.js.map