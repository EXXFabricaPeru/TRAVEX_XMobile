...
var Equipox = (function () {
    ...
    Equipox.prototype.windowEliminar = function (id) {
        var _this = this;
        var obj = {
    ...
    Equipox.prototype.windowEdit = function (id) {
        var _this = this;
        this.element.html('<div class="loader">Loading...</div>');
        var option = {
            title: 'ACTUALIZAR REGISTRO',
            open: function () {
                _this.element.load(_this.url + 'equipox/update&id=' + id);
            },
            buttons: [{
                    text: "GUARDAR",
                    class: "btn btn-success",
    ...
    Equipox.prototype.windowPdf = function (id) {
        var url = this.url + 'equipox/report&id=' + id;
        $("#windowpdf").dialog({
    ...
    Equipox.prototype.requestPut = function (id, data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: _this.url + 'equipox/update&id=' + id,
                type: 'PUT',
                data: data,
    ...
    Equipox.prototype.requestDelete = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.get(_this.url + 'equipox/eliminar&id=' + data).done(function (data) {
                resolve(data);
            }).fail(function (err) {
                reject(err);
            });
    ...
    Equipox.prototype.requestPost = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: _this.url + 'equipox/create',
                type: 'POST',
                data: data,
                success: function (data, status, xhr) {
                    resolve(JSON.parse(data));
...
//# sourceMappingURL=Equipox.js.map