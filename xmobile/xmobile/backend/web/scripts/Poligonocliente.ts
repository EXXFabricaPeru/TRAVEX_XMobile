...
class Poligonocliente {
    ...
    constructor() {
        ...
        this.setting = {width: '80%', height: '700', hide: 'fade', show: 'fade', modal: true};
    }
    ...
    public windowCreate() {
        ...
        let option = {
            ...
            open: () => {
                this.element.load(this.url + 'poligonocliente/create');
            },
            buttons: [{
                text: "REGISTRAR",
                class: "btn btn-success",
                click:   async () => {
                    let data = $('#Poligonocliente-form').serialize();
    ...
    public windowEdit(id: any) {
        ...
        let option = {
            ...
            open: () => {
                this.element.load(this.url + 'poligonocliente/update&id=' + id);
            },
            buttons: [{
                text: "GUARDAR",
                class: "btn btn-success",
    ...
    public windowPdf(id: any) {
        let url = this.url + 'poligonocliente/report&id=' + id;
        $("#windowpdf").dialog({
    ...
    private requestPut(id: any, data: any) {
        return new Promise((resolve, reject) => {
            $.ajax({
                url: this.url + 'poligonocliente/update&id=' + id,
                type: 'PUT',
                data: data,
    ...
    private requestDelete(data: any) {
        return new Promise((resolve, reject) => {
            $.get(this.url + 'poligonocliente/eliminar&id=' + data).done((data) => {
                resolve(data);
            }).fail((err) => {
                reject(err);
            });
    ...
    private requestPost(data: any) {
        return new Promise((resolve, reject) => {
            $.ajax({
                url: this.url + 'poligonocliente/create',
                type: 'POST',
                data: data,
                success: (data, status, xhr) => {
                    resolve(JSON.parse(data));
    ...
    public windowView(id) {
        ...
        let option = {
            ...
            open: () => {
                ...
                this.element.load(this.url + 'poligonocliente/recuperarclientes&id=' + id, () => {
                });
            }
        };
        let opt: any = this.Objet.assign(this.setting, option);
