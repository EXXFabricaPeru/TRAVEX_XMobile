...
var Sucursalx = (function () {
    function Sucursalx() {
        this.element = $(".window");
        this.url = $("#PATH").attr("name");
        this.Objet = Object;
        this.elementGrid = "#Sucursalx-list";
        this.setting = { width: '80%', height: 500, hide: 'fade', show: 'fade', modal: true };
    }
    Sucursalx.prototype.windowCreate = function () {
        var _this = this;
        this.element.html('<div class="loader">Loading...</div>');
        var option = {
            title: 'NUEVO REGISTRO',
            open: function () {
                _this.element.load(_this.url + 'sucursalx/create');
            },
            buttons: [{
                    text: "REGISTRAR",
    ...
    Sucursalx.prototype.windowEliminar = function (id) {
        var _this = this;
        var obj = {
    ...
    Sucursalx.prototype.windowEdit = function (id) {
        var _this = this;
        this.element.html('<div class="loader">Loading...</div>');
        var option = {
            title: 'ACTUALIZAR REGISTRO',
            open: function () {
                _this.element.load(_this.url + 'sucursalx/update&id=' + id);
            },
            buttons: [{
                    text: "GUARDAR",
                    class: "btn btn-success",
    ...
    Sucursalx.prototype.windowPdf = function (id) {
        var url = this.url + 'sucursalx/report&id=' + id;
        $("#windowpdf").dialog({
    ...
    Sucursalx.prototype.requestPut = function (id, data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: _this.url + 'sucursalx/update&id=' + id,
                type: 'PUT',
                data: data,
    ...
    Sucursalx.prototype.requestDelete = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.get(_this.url + 'sucursalx/eliminar&id=' + data).done(function (data) {
                resolve(data);
            }).fail(function (err) {
                reject(err);
            });
    ...
    Sucursalx.prototype.requestPost = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: _this.url + 'sucursalx/create',
                type: 'POST',
                data: data,
                success: function (data, status, xhr) {
                    resolve(JSON.parse(data));
...
//# sourceMappingURL=Sucursalx.js.map