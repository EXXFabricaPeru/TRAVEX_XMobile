...
class Equipoxcuentascontables {
    ...
    public windowCreate() {
        ...
        let option = {
            ...
            open: () => {
                this.element.load(this.url + 'equipoxcuentascontables/create');
            },
            buttons: [{
                text: "REGISTRAR",
                class: "btn btn-success",
                click: async () => {
                    let data = $('#Equipoxcuentascontables-form').serialize();
    ...
    public windowEdit(id: any) {
        ...
        let option = {
            ...
            open: () => {
                this.element.load(this.url + 'equipoxcuentascontables/update&id=' + id);
            },
            buttons: [{
                text: "GUARDAR",
                class: "btn btn-success",
    ...
    public windowPdf(id: any) {
        let url = this.url + 'equipoxcuentascontables/report&id=' + id;
        $("#windowpdf").dialog({
    ...
    private requestPut(id: any, data: any) {
        return new Promise((resolve, reject) => {
            $.ajax({
                url: this.url + 'equipoxcuentascontables/update&id=' + id,
                type: 'PUT',
                data: data,
    ...
    private requestDelete(data: any) {
        return new Promise((resolve, reject) => {
            $.get(this.url + 'equipoxcuentascontables/eliminar&id=' + data).done((data) => {
                resolve(data);
            }).fail((err) => {
                reject(err);
            });
    ...
    private requestPost(data: any) {
        return new Promise((resolve, reject) => {
            $.ajax({
                url: this.url + 'equipoxcuentascontables/create',
                type: 'POST',
                data: data,
                success: (data, status, xhr) => {
                    resolve(JSON.parse(data));
...
$(() => {
    ...
    let model = new Equipoxcuentascontables();
    $("#btn-create-cuentas").on('click', () => {
        model.windowCreate();
    });
    $(document).on("click", "#btn-editar-cuentas", function () {
        let id = $("#idListViewCuentas").attr("name");
        model.windowEdit(id);
    });
