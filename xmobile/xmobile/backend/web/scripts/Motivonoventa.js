...
var Motivonoventa = (function () {
    function Motivonoventa() {
        this.element = $(".window");
        this.url = $("#PATH").attr("name");
        this.Objet = Object;
        this.elementGrid = "#Motivonoventa-list";
        this.setting = { width: '80%', height: 500, hide: 'fade', show: 'fade', modal: true };
    }
    Motivonoventa.prototype.windowCreate = function () {
        var _this = this;
        this.element.html('<div class="loader">Loading...</div>');
        var option = {
            title: 'NUEVO REGISTRO',
            open: function () {
                _this.element.load(_this.url + 'motivonoventa/create');
            },
            buttons: [{
                    text: "REGISTRAR",
                    ...
                    click: function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    data = $('#Motivonoventa-form').serialize();
    ...
    Motivonoventa.prototype.windowEliminar = function (id) {
        var _this = this;
        var obj = {
    ...
    Motivonoventa.prototype.windowEdit = function (id) {
        var _this = this;
        this.element.html('<div class="loader">Loading...</div>');
        var option = {
            title: 'ACTUALIZAR REGISTRO',
            open: function () {
                _this.element.load(_this.url + 'motivonoventa/update&id=' + id);
            },
            buttons: [{
                    text: "GUARDAR",
                    class: "btn btn-success",
    ...
    Motivonoventa.prototype.windowPdf = function (id) {
        var url = this.url + 'motivonoventa/report&id=' + id;
        $("#windowpdf").dialog({
    ...
    Motivonoventa.prototype.requestPut = function (id, data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: _this.url + 'motivonoventa/update&id=' + id,
                type: 'PUT',
                data: data,
    ...
    Motivonoventa.prototype.requestDelete = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.get(_this.url + 'motivonoventa/eliminar&id=' + data).done(function (data) {
                resolve(data);
            }).fail(function (err) {
                reject(err);
            });
    ...
    Motivonoventa.prototype.requestPost = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: _this.url + 'motivonoventa/create',
                type: 'POST',
                data: data,
                success: function (data, status, xhr) {
                    resolve(JSON.parse(data));
...
//# sourceMappingURL=Motivonoventa.js.map