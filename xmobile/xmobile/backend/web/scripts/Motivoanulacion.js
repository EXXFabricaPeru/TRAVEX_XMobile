...
var Motivoanulacion = (function () {
    function Motivoanulacion() {
        this.element = $(".window");
        this.url = $("#PATH").attr("name");
        this.Objet = Object;
        this.elementGrid = "#Motivoanulacion-list";
        this.setting = { width: '80%', height: 500, hide: 'fade', show: 'fade', modal: true };
    }
    Motivoanulacion.prototype.windowCreate = function () {
        var _this = this;
        this.element.html('<div class="loader">Loading...</div>');
        var option = {
            title: 'NUEVO REGISTRO',
            open: function () {
                _this.element.load(_this.url + 'motivoanulacion/create');
            },
            buttons: [{
                    text: "REGISTRAR",
                    ...
                    click: function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    data = $('#Motivoanulacion-form').serialize();
    ...
    Motivoanulacion.prototype.windowEliminar = function (id) {
        var _this = this;
        var obj = {
    ...
    Motivoanulacion.prototype.windowEdit = function (id) {
        var _this = this;
        this.element.html('<div class="loader">Loading...</div>');
        var option = {
            title: 'ACTUALIZAR REGISTRO',
            open: function () {
                _this.element.load(_this.url + 'motivoanulacion/update&id=' + id);
            },
            buttons: [{
                    text: "GUARDAR",
                    class: "btn btn-success",
    ...
    Motivoanulacion.prototype.windowPdf = function (id) {
        var url = this.url + 'motivoanulacion/report&id=' + id;
        $("#windowpdf").dialog({
    ...
    Motivoanulacion.prototype.requestPut = function (id, data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: _this.url + 'motivoanulacion/update&id=' + id,
                type: 'PUT',
                data: data,
    ...
    Motivoanulacion.prototype.requestDelete = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.get(_this.url + 'motivoanulacion/eliminar&id=' + data).done(function (data) {
                resolve(data);
            }).fail(function (err) {
                reject(err);
            });
    ...
    Motivoanulacion.prototype.requestPost = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: _this.url + 'motivoanulacion/create',
                type: 'POST',
                data: data,
                success: function (data, status, xhr) {
                    resolve(JSON.parse(data));
...
//# sourceMappingURL=Motivoanulacion.js.map