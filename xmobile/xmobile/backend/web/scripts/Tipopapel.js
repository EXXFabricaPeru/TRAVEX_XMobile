...
var Tipopapel = /** @class */ (function () {
    function Tipopapel() {
        this.element = $(".window");
        this.url = $("#PATH").attr("name");
        this.Objet = Object;
        this.elementGrid = "#Tipopapel-list";
        this.setting = { width: 400, height: 400, hide: 'fade', show: 'fade', modal: true };
    }
    Tipopapel.prototype.windowCreate = function () {
        var _this = this;
        this.element.html('<div class="loader">Loading...</div>');
        var option = {
            title: 'NUEVO REGISTRO',
            open: function () {
                _this.element.load(_this.url + 'tipopapel/create');
            },
            buttons: [{
                    text: "REGISTRAR",
    ...
    Tipopapel.prototype.windowEliminar = function (id) {
        var _this = this;
        var obj = {
    ...
    Tipopapel.prototype.windowEdit = function (id) {
        var _this = this;
        this.element.html('<div class="loader">Loading...</div>');
        var option = {
            title: 'ACTUALIZAR REGISTRO',
            open: function () {
                _this.element.load(_this.url + 'tipopapel/update&id=' + id);
            },
            buttons: [{
                    text: "GUARDAR",
                    "class": "btn btn-success",
    ...
    Tipopapel.prototype.windowPdf = function (id) {
        var url = this.url + 'tipopapel/report&id=' + id;
        $("#windowpdf").dialog({
    ...
    Tipopapel.prototype.requestPut = function (id, data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: _this.url + 'tipopapel/update&id=' + id,
                type: 'PUT',
                data: data,
    ...
    Tipopapel.prototype.requestDelete = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.get(_this.url + 'tipopapel/eliminar&id=' + data).done(function (data) {
                resolve(data);
            }).fail(function (err) {
                reject(err);
            });
    ...
    Tipopapel.prototype.requestPost = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: _this.url + 'tipopapel/create',
                type: 'POST',
                data: data,
                success: function (data, status, xhr) {
                    resolve(JSON.parse(data));
