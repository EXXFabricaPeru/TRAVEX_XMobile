...
var Geolocalizacion = (function () {
    function Geolocalizacion() {
        ...
        this.Objet = Object;
        this.elementGrid = "#Geolocalizacion-list";
        this.setting = { width: '80%', height: 500, hide: 'fade', show: 'fade', modal: true };
    }
    Geolocalizacion.prototype.windowCreate = function () {
        var _this = this;
        this.element.html('<div class="loader">Loading...</div>');
        var option = {
            title: 'NUEVO REGISTRO',
            open: function () {
                _this.element.load(_this.url + 'geolocalizacion/create');
            },
            buttons: [{
                    text: "REGISTRAR",
                    ...
                    click: function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    data = $('#Geolocalizacion-form').serialize();
    ...
    Geolocalizacion.prototype.windowEliminar = function (id) {
        var _this = this;
        var obj = {
    ...
    Geolocalizacion.prototype.windowEdit = function (id) {
        var _this = this;
        this.element.html('<div class="loader">Loading...</div>');
        var option = {
            title: 'ACTUALIZAR REGISTRO',
            open: function () {
                _this.element.load(_this.url + 'geolocalizacion/update&id=' + id);
            },
            buttons: [{
                    text: "GUARDAR",
                    class: "btn btn-success",
    ...
    Geolocalizacion.prototype.windowPdf = function (id) {
        var url = this.url + 'geolocalizacion/report&id=' + id;
        $("#windowpdf").dialog({
    ...
    Geolocalizacion.prototype.requestPut = function (id, data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: _this.url + 'geolocalizacion/update&id=' + id,
                type: 'PUT',
                data: data,
    ...
    Geolocalizacion.prototype.requestDelete = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.get(_this.url + 'geolocalizacion/eliminar&id=' + data).done(function (data) {
                resolve(data);
            }).fail(function (err) {
                reject(err);
            });
    ...
    Geolocalizacion.prototype.requestPost = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: _this.url + 'geolocalizacion/create',
                type: 'POST',
                data: data,
                success: function (data, status, xhr) {
                    resolve(JSON.parse(data));
...
//# sourceMappingURL=Geolocalizacion.js.map