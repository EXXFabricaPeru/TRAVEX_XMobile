...
var Almacenes = (function () {
    function Almacenes() {
        ...
        this.Objet = Object;
        this.elementGrid = "#Almacenes-list";
        this.setting = { width: '80%', height: 500, hide: 'fade', show: 'fade', modal: true };
    }
    Almacenes.prototype.windowCreate = function () {
        var _this = this;
        this.element.html('<div class="loader">Loading...</div>');
        var option = {
            title: 'NUEVO REGISTRO',
            open: function () {
                _this.element.load(_this.url + 'almacenes/create');
            },
            buttons: [{
                    text: "REGISTRAR",
    ...
    Almacenes.prototype.windowEliminar = function (id) {
        var _this = this;
        var obj = {
    ...
    Almacenes.prototype.windowEdit = function (id) {
        var _this = this;
        this.element.html('<div class="loader">Loading...</div>');
        var option = {
            title: 'ACTUALIZAR REGISTRO',
            open: function () {
                _this.element.load(_this.url + 'almacenes/update&id=' + id);
            },
            buttons: [{
                    text: "GUARDAR",
                    class: "btn btn-success",
    ...
    Almacenes.prototype.windowPdf = function (id) {
        var url = this.url + 'almacenes/report&id=' + id;
        $("#windowpdf").dialog({
    ...
    Almacenes.prototype.requestPut = function (id, data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: _this.url + 'almacenes/update&id=' + id,
                type: 'PUT',
                data: data,
    ...
    Almacenes.prototype.requestDelete = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.get(_this.url + 'almacenes/eliminar&id=' + data).done(function (data) {
                resolve(data);
            }).fail(function (err) {
                reject(err);
            });
    ...
    Almacenes.prototype.requestPost = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: _this.url + 'almacenes/create',
                type: 'POST',
                data: data,
                success: function (data, status, xhr) {
                    resolve(JSON.parse(data));
