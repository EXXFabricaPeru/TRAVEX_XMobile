...
var Configuracion = /** @class */ (function () {
    ...
    Configuracion.prototype.windowCreate = function () {
        var _this = this;
        this.element.html('<div class="loader">Loading...</div>');
        var option = {
            title: 'NUEVO REGISTRO',
            open: function () {
                _this.element.load(_this.url + 'configuracion/create');
            },
            buttons: [{
                    text: "REGISTRAR",
    ...
    Configuracion.prototype.windowEliminar = function (id) {
        var _this = this;
        var obj = {
    ...
    Configuracion.prototype.windowEdit = function (id) {
        var _this = this;
        this.element.html('<div class="loader">Loading...</div>');
        var option = {
            title: 'ACTUALIZAR REGISTRO',
            open: function () {
                _this.element.load(_this.url + 'configuracion/update&id=' + id);
            },
            buttons: [{
                    text: "GUARDAR",
                    "class": "btn btn-success",
    ...
    Configuracion.prototype.windowPdf = function (id) {
        var url = this.url + 'configuracion/report&id=' + id;
        $("#windowpdf").dialog({
    ...
    Configuracion.prototype.requestPut = function (id, data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: _this.url + 'configuracion/update&id=' + id,
                type: 'PUT',
                data: data,
    ...
    Configuracion.prototype.requestDelete = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.get(_this.url + 'configuracion/eliminar&id=' + data).done(function (data) {
                resolve(data);
            }).fail(function (err) {
                reject(err);
            });
    ...
    Configuracion.prototype.requestPost = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: _this.url + 'configuracion/create',
                type: 'POST',
                data: data,
                success: function (data, status, xhr) {
                    resolve(JSON.parse(data));
