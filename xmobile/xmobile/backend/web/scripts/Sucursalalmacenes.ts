...
class Sucursalalmacenes {
    ...
    public windowCreate() {
        ...
        let option = {
            ...
            open: () => {
                this.element.load(this.url + 'sucursalalmacenes/create', () => {
                    this.loadViewFrom();
                });
            },
            buttons: [{
                ...
                click: async () => {
                    let data = $('#Sucursalalmacenes-form').serialize();
    ...
    public windowEdit(id: any) {
        ...
        let option = {
            ...
            open: () => {
                this.element.load(this.url + 'sucursalalmacenes/update&id=' + id, () => {
                    this.loadViewFrom();
                });
            },
            buttons: [{
    ...
    public windowPdf(id: any) {
        let url = this.url + 'sucursalalmacenes/report&id=' + id;
        $("#windowpdf").dialog({
    ...
    private requestPut(id: any, data: any) {
        return new Promise((resolve, reject) => {
            $.ajax({
                url: this.url + 'sucursalalmacenes/update&id=' + id,
                type: 'PUT',
                data: data,
    ...
    private requestDelete(data: any) {
        return new Promise((resolve, reject) => {
            $.get(this.url + 'sucursalalmacenes/eliminar&id=' + data).done((data) => {
                resolve(data);
            }).fail((err) => {
                reject(err);
            });
    ...
    private requestPost(data: any) {
        return new Promise((resolve, reject) => {
            $.ajax({
                url: this.url + 'sucursalalmacenes/create',
                type: 'POST',
                data: data,
                success: (data, status, xhr) => {
                    resolve(JSON.parse(data));
...
$(() => {
    let model = new Sucursalalmacenes();
    $("#btn-create").on('click', () => {
        model.windowCreate();
    });
