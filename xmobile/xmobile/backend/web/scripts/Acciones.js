...
var Acciones = (function () {
    function Acciones() {
        ...
        this.Objet = Object;
        this.elementGrid = "#Acciones-list";
        this.setting = { width: 350, height: 400, hide: 'fade', show: 'fade', modal: true };
    }
    Acciones.prototype.fromaction = function () {
        $("#acciones-nombre").keyup(function () {
            var str = $(this).val();
            var res = str.replace(/ /g, "-");
            $("#acciones-cod").val(res.toLowerCase());
        });
    };
    Acciones.prototype.windowCreate = function () {
        var _this = this;
        this.element.html('<div class="loader">Loading...</div>');
        var option = {
            title: 'NUEVO REGISTRO',
            open: function () {
                _this.element.load(_this.url + 'acciones/create', function () {
                    _this.fromaction();
                });
            },
            buttons: [{
    ...
    Acciones.prototype.windowEdit = function (id) {
        var _this = this;
        this.element.html('<div class="loader">Loading...</div>');
        var option = {
            title: 'ACTUALIZAR REGISTRO',
            open: function () {
                _this.element.load(_this.url + 'acciones/update&id=' + id, function () {
                    _this.fromaction();
                });
            },
            buttons: [{
    ...
    Acciones.prototype.windowPdf = function (id) {
        var url = this.url + 'acciones/report&id=' + id;
        $("#windowpdf").dialog({
    ...
    Acciones.prototype.requestPut = function (id, data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: _this.url + 'acciones/update&id=' + id,
                type: 'PUT',
                data: data,
    ...
    Acciones.prototype.requestDelete = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.get(_this.url + 'acciones/eliminar&id=' + data).done(function (data) {
                resolve(data);
            }).fail(function (err) {
                reject(err);
            });
    ...
    Acciones.prototype.requestPost = function (data) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            $.ajax({
                url: _this.url + 'acciones/create',
                type: 'POST',
                data: data,
                success: function (data, status, xhr) {
                    resolve(JSON.parse(data));
