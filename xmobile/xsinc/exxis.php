...
class conexion{
    ...
    private function conectarbd(){       
            if($this->motor=="hana") {
                ...
                //$dsn = 'odbc:driver={HDBODBC32};SERVERNODE='.$this->dbsrv.':30013;DATABASENAME=NDB;DATABASE='.$this->base.';UID='.$username.';PWD='.$password.';charset=utf8mb4;CHAR_AS_UTF8=true';
                //$dsn = 'odbc:driver={HDBODBC32};SERVERNODE='.$this->dbsrv.':30015;DATABASE='.$this->base.';UID='.$username.';PWD='.$password.';charset=utf8mb4';
                $dsn = 'odbc:driver={HDBODBC32};SERVERNODE='.$this->dbsrv.':30015;DATABASE='.$this->base.';UID='.$username.';PWD='.$password.'#;charset=utf8mb4;CHAR_AS_UTF8=true';
                //$dsn = 'odbc:driver={HDBODBC32};SERVERNODE=192.168.50.72:30015;DATABASE=SBO_PRU;charset=utf8mb4';
                //$dsn = 'odbc:driver={HDBODBC32};SERVERNODE='.$this->dbsrv.':30015;DATABASE='.$this->base.';UID='.$username.';PWD='.$password.';charset=utf8mb4';
               ...
               $this->db = new dbo(
                 ...
                 $this->db->query(' SET SCHEMA "'.$this->base.'";');
    ...
    public function devolver_datos_tabla3($tabla,$campos,$condicion,$debug=0){ 
        $salida=[];
	...
	public function ejecutarConsulta($consulta,$debug=0){ 
         $salida=[];
		...
		if($result){ 
            ...
            $salida=array("estado"=>200,"consulta"=>$consulta,"resultado"=>$result,"json"=>$this->utf8_converter($result));
