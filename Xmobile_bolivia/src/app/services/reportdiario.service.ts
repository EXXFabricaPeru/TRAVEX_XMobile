...
export class ReportdiarioService {
    public layout;
    public pdfObj = null;
    public objPDF: any;
    public metadata: any;
    public monedalocal: any;
    

    constructor(private file: File, private fileOpener: FileOpener, private _configLayaut:ConfigLayautService,private configService: ConfigService, private spinnerDialog: SpinnerDialog,private dataService: DataService,private network: Network ) {
      this.moneda();
    }
    ...
    public async moneda(){
        ...
        console.log(conarr);
        let aux  = conarr[0].monedas.filter(value => value.Type == "L");
        this.monedalocal = aux[0].Code;
        console.log(this.monedalocal);
    }
    ...
    public async reportResumenCaja(date) {
        ...
        let dataBs = dataResumenCaja.filter((item) => {
            return item.moneda == this.monedalocal;
        });
                ...
                content: [
                    {
                        ...
                        text: 'Total '+this.monedalocal+'. ' + totalFacturasBs,
                    }, '', {
                    ...
                    , '', {
                        text: 'Total '+this.monedalocal+'. ' + totalFacturasBsCuenta,
                    }, '', {
                ...
                content: [
                    {
                        ...
                        text: 'I) Pagos Activos en Moneda Local ('+this.monedalocal+'.)',
                    }, '\n', {
                        table: tabelarrBS
                    }, '', {
                        text: 'Total '+this.monedalocal+'. ' + totalBs,
                    }, '\n', {
                    ...
                    , '\n', {
                        text: 'I) Pagos Activos anulados en Moneda Local ('+this.monedalocal+'.)',
                    }, '\n', {
                        table: tabelarrBSAnulado
                    }, '', {
                        text: 'Total '+this.monedalocal+'. ' + totalBsanulado,
                ...
                content: [
                    {
                        ...
                        text: 'Total '+this.monedalocal+'. ' + formatNumber((MontoTotal), 'en-US', '1.2-2'),
                    }, '', {
                        text: 'Total '+this.monedalocal+'. Anulado ' + formatNumber((MontoTotalAnulado), 'en-US', '1.2-2'),
                    }
                ],
                styles: {
                    header: {
                ...
                content: [
                    {
                        ...
                        text: 'Total '+this.monedalocal+'. ' + formatNumber((MontoTotalOferta), 'en-US', '1.2-2'),
                    }, {
                    ...
                    , '\n', {
                        ...
                        text: 'Total '+this.monedalocal+'. ' + formatNumber((MontoTotalPedido), 'en-US', '1.2-2'),
                    }, {
                    ...
                    , '\n', {
                        ...
                        text: 'Total '+this.monedalocal+'. ' + formatNumber((MontoTotalFactura), 'en-US', '1.2-2'),
                    }, {
                    ...
                    , '\n', {
                        ...
                        text: 'Total '+this.monedalocal+'. ' + formatNumber((MontoTotalEntrega), 'en-US', '1.2-2'),
                    }, {
    ...
    public async reportResumenCajaDetalleRollo(date) {
        ...
        for (let val of typeMethodPayments)
        {
            ...
            console.log("data documentos USD", dataPaymentUsd);
            ...
            console.log("data documentos fall USD", dataPaymentUsdfall);
            ...
            console.log("datos a recorrer",dataPaymentBs);

            for (let dataValue of dataPaymentBs){
                console.log("datos a sumar",dataValue);
                //subTotalPayment = 0;
                let tipoOperacion = "";
                ...
                montoSubTotal = dataValue.monedaDolar==0 || dataValue.monedaDolar=='' || dataValue.monedaDolar=='null' || dataValue.monedaDolar==null?dataValue.monto:dataValue.monedaLocal-dataValue.cambio;
        ...
        return new Promise((resolve, reject) => {
            this.objPDF = {
                ...
                content: [
                    ...
                    {
                        text: '\n  Cobro en '+this.monedalocal+'. ' , style: 'subheader'
                    },
                    cuerpodetalle1,
                    {
        ...
        for (let value of dataParam) {
            ...
            */
            ...
            /*  header = {
                  columns: [
                      {
                          text: `\n FECHA `, style: ['small'], width: '50%'
                      },
                      {
                          text: `\n ${value.fecha}`, style: ['small'], alignment: 'right',
                      }
                  ],
              };
              cuerpodetalle.push(header);*/
            ...
            header = {
                columns: [
                    ...
                    {
                        text: `\n ${formatNumber((value.monedaDolar), 'en-US', '1.2-2')} (${this.monedalocal}. ${formatNumber((pagoBs), 'en-US', '1.2-2')})`, style: ['small'], alignment: 'right', lineHeight: valueInterlineado
                    }
                ],
            };
            cuerpodetalle.push(header);
        ...
        return new Promise((resolve, reject) => {
            this.objPDF = {
                ...
                content: [
                    ...
                    cuerpodetalle,
                    {
                        text: '\n Total '+this.monedalocal+'. ' + formatNumber((MontoTotal), 'en-US', '1.2-2'), style: 'subheader'
                    }, '', {
                        text: 'Total '+this.monedalocal+'. Anulado ' + formatNumber((MontoTotalAnulado), 'en-US', '1.2-2'), style: 'subheader'
                    }
                ],
        ...
        return new Promise((resolve, reject) => {
            this.objPDF = {
                ...
                content: [
                    ...
                    TablaOfertas
                    , {
                        text: '\n Total '+this.monedalocal+'. ' + formatNumber((MontoTotalOferta), 'en-US', '1.2-2'), style: 'subheader'
                    }, {
                    ...
                    TablaPedidos
                    , {
                        text: '\n Total '+this.monedalocal+'. ' + formatNumber((MontoTotalPedido), 'en-US', '1.2-2'), style: 'subheader'
                    }, {
                    ...
                    TablaFacturas
                    , {
                        text: '\n Total '+this.monedalocal+'. ' + formatNumber((MontoTotalFactura), 'en-US', '1.2-2'), style: 'subheader'
                    }, {
                    ...
                    TablaEntregas
                    , {
                        text: '\n Total '+this.monedalocal+'. ' + formatNumber((MontoTotalEntrega), 'en-US', '1.2-2'), style: 'subheader'
                    }, {
        ...
        dataSelect2.forEach(element => {
            ...
            if (Number(element.cantidad_compra) > 0) {
                ...
                if(cantidad.length > 0){
                    header2 = { columns: [{ text: `\n  Objetivo de Venta (${this.monedalocal}.) : ${cantidad[0].monto_total}   \n`, style: ['subheader'], width: '90%' }], };
                }
                ...
                this.objPDF = {
                    ...
                    content: [
                        ...
                        },
                        {
                            ...
                            columns: [
                                {
                                    text: 'Declarado '+this.monedalocal+' ',
                                    style: ['small'],
                                    alignment: 'letf',
                                    width: '40%',
                                },
            ...
            for await (const items of prod) {
                if(almac.WarehouseCode == items.WarehouseCode){
                    datos.push({
                        ...
                        cantidad: parseInt(items.InStock),
