...
export class ReportStyleUnoService {
  ...
  private _configLayaut:ConfigLayautService
    ...
    public async generareciboV2(dataPagoPdf: IDataPagoPdf, datauser: any) {
        ...
        let nombre_cliente = "";
        dataConfigLayaut = dataConfigLayaut.find(e=>e.type_document=='REC');
        ...
        if (dataPagoPdf.dataPago.mediosPago[0].bancoCode != '') {
            ...
            console.log("datos del banco",fx);
        ...
        return new Promise(async (resolve, reject) => {
            ...
            try {
                ...
                let tipopago = '';
                console.log("data pago", dataPagoPdf.dataPago.mediosPago[0].formaPago)
                switch (dataPagoPdf.dataPago.mediosPago[0].formaPago) {
                    case ('PCC'):
                        montoDolarExtra = '';
                        montoDolarExtra2 = '';
                        montopagolocal = '';
                        tipopago = 'TARJETA \n Baucher: ' + dataPagoPdf.dataPago.mediosPago[0].baucher;
                        break;
                    case ('PEF'):
                        tipopago = 'EFECTIVO';
                        ...
                        if (dataPagoPdf.dataPago.moneda != 'BS') {
                            ...
                            let resAux = 0;
                            // let resAux = (Number(txt.cambio) + Number(DocumentTotalPay)) - Number(txt.monedaDolar * txt.tipoCambioDolar);
                            // console.log("(Number(txt[0].cambio) + Number(DocumentTotalPay))  ", (Number(txt.cambio) + Number(DocumentTotalPay)));
                            // console.log("-  Number(txt[0].monedaDolar * txt[0].tipoCambioDolar) ", Number(txt.monedaDolar * txt.tipoCambioDolar))

                            montoDolarExtra = {
                                //text: 'Pago en USD : ' + txt[0].monedaDolar + '  (' + Calculo.formatMoney((txt.monedaDolar * txt.tipoCambioDolar).toFixed(2)) + ' Bs.)',
                            ...
                            if(dataPagoPdf.dataPago.mediosPago[0].monedaDolar > 0 ){
                                montoDolarExtra = {
                                    text: 'Pago en USD  '+dataPagoPdf.dataPago.mediosPago[0].monedaDolar,
                                    style: ['xsmall']
                                };
                                montopagolocal = {
                                    text: 'Pago en Bs : '+dataPagoPdf.dataPago.mediosPago[0].monedaLocal,
                                    style: ['xsmall']
                                };
                            }else{
                                montoDolarExtra = '';
                    ...
                    case ('PCH'):
                        montoDolarExtra = '';
                        montoDolarExtra2 = '';
                        tipopago = 'CHEQUE \n # Cheque: ' + dataPagoPdf.dataPago.mediosPago[0].numCheque + ' \n  Banco: (' + dataPagoPdf.dataPago.mediosPago[0].bancoCode + ') ' + bombrebanco;
                        break;
                    case ('PBT'):
                        montoDolarExtra = '';
                        montoDolarExtra2 = '';
                        tipopago = 'TRANSFERENCIA \n # Trans: ' + dataPagoPdf.dataPago.mediosPago[0].numComprobante + ' \n  Banco Code: (' + dataPagoPdf.dataPago.mediosPago[0].bancoCode + ') ' + bombrebanco;
                        break;
                }
                let $hoy = new Date();
                let $aux_hoy = formatDate($hoy, 'dd/MM/yyyy HH:mm', 'en-US');
                this.objPDF = {
                    ...
                    styles: {
                        header:dataConfigLayaut && dataConfigLayaut?JSON.parse(dataConfigLayaut.title): {
                            fontSize: 5,
                            bold: true
                        },
                        subheader: dataConfigLayaut && dataConfigLayaut?JSON.parse(dataConfigLayaut.sub_title):{
                            fontSize: 4,
                            bold: true
                        },
                        number: dataConfigLayaut && dataConfigLayaut?JSON.parse(dataConfigLayaut.sub_title):{
                            fontSize: 4
                        },
                        small:dataConfigLayaut && dataConfigLayaut?JSON.parse(dataConfigLayaut.description): {
                            fontSize: 3
                        },
                        xsmall:dataConfigLayaut && dataConfigLayaut?JSON.parse(dataConfigLayaut.xsmall): {
                            fontSize: 2.5
                        }
                    }
                };
    ...
    public async  docFactura(cliente: any, pedido: any, detalles: any, userdata: any, contador: any) {
        window.parent.caches.delete("call");
        ...
        console.groupEnd();
        let dataConfigLayaut = await this._configLayaut.getConfig();
        dataConfigLayaut = dataConfigLayaut.find(e => e.type_document == 'DFA');
        console.log("data layaut pedidos", dataConfigLayaut);
    ...
    public async docFacturaV2(cliente: any, pedido: any, detalles: any, userdata: any, contador: any) {
        ...
        dataConfigLayaut = dataConfigLayaut.find(e=>e.type_document=='DFA');
            ...
            console.log("userdata", userdata);
        console.log("userdata", userdata[0].docificacion);
        console.log("data config service",dataConfigLayaut)
        console.groupEnd();
        ...
        try {
            ...
            if (userdata[0].uso_fex == '1') {
                if (cliente.U_EXX_FE_Cuf != '0') {
                    ...
                    U_Leyenda2 = 'Este documento es la Representación Gráfica de un Documento Fiscal Digital emitido en una modalidad de facturación en línea';
        ...
        return new Promise((resolve, reject) => {
            ...
            if (pedido.origen == 'outer') {
                ...
                if (ruta2 == '0') {
                    if(xxx == 1){
                        ruta2 = "http://localhost:1433/visorfactura/consulta.php"+userdata[0].fex_url + '?doc=' + pedido.cod + '&nit=' + cliente.FederalTaxId;
                        qrx = {
                            text: '\n\n' + ruta2 + '\n\n',
                            style: ['xsmall'],
                            alignment: 'center',
            ...
            for (let detal of detalles) {
                ...
                let aux_totalneto = detal.Price * detal.Quantity;
                ...
                sub_total = sub_total + Number(aux_totalneto);
                total_descuento = total_descuento + Number(detal.U_4DESCUENTO);
                ...
                if ((userdata[0].localizacion == 2) || (userdata[0].localizacion == 1)) {
                    ...
                    header = [
                        ...
                        },
                        {
                            ...
                            columns: [
                                {
                                    text: ` ${priceUnit} X ${quantity} -  ${aux_descuento} ${desicee}`,
            ...
            try {
                this.objPDF = {
                    ...
                    content: [
                        ...
                        {
                            text: userdata[0].docificacion[0]?userdata[0].docificacion[0].fex_sucursaln:'',
                            alignment: 'center',
                            style: ['small']
                        },
                        {
                        ...
                        },
                        {
                            ...
                            text: userdata[0].docificacion[0]?userdata[0].docificacion[0].fex_puntoventan:'',
                            alignment: 'center',
                            style: ['small']
                        },
                        {
                        ...
                        },
                        {
                            columns: [
                                ...
                                {
                                    text: Calculo.formatMoney(sub_total),
                                    style: ['small'],
                                    bold: true,
                                    alignment: 'right',
                                }
                        ...
                        total_icep,
                        {
                            columns: [
                                ...
                                {
                                    text: Calculo.formatMoney(total_descuento),
                                    style: ['small'],
                                    bold: true,
                                    alignment: 'right',
                                }
                        ...
                        },
                        {
                            columns: [
                                ...
                                {
                                    text: Calculo.formatMoney(pedido.DocumentTotalPay),
                                    style: ['small'],
                                    bold: true,
                                    alignment: 'right',
                                }
                        ...
                        },
                        {
                            columns: [
                                {
                                    text: 'IMPORTE BASE CREDITO FISCAL Bs',
                                    style: ['xsmall'],
                                    width: '70%',
                                    bold: true,
                                    alignment: 'right',
                ...
                console.log("data impresion->", this.objPDF);
                resolve(true);
            } catch (e) {
                reject(e);
            }
    ...
    public async factura(cliente: any, pedido: any, detalles: any, userdata: any, contador: any, acc: string) {
        ...
        let dataConfigLayaut = await this._configLayaut.getConfig();
        dataConfigLayaut = dataConfigLayaut.find(e => e.type_document == 'DOP');
        console.log("data layaut pedidos->", dataConfigLayaut);
                ...
                try {
                    this.objPDF = {
                        ...
                        styles: {
                            ...
                            number: dataConfigLayaut?JSON.parse(dataConfigLayaut.sub_title):{
                                fontSize: 4
                            },
                    ...
                    console.log("data pedidos no furula",this.objPDF)
                    resolve(true);
                } catch (e) {
                    reject(e);
                }
                ...
                try {
                    this.objPDF = {
                        ...
                        styles: {
                            ...
                            xxsmall: dataConfigLayaut && dataConfigLayaut?JSON.parse(dataConfigLayaut.xsmall):{
                                fontSize: 1.5
                            }
                        }
                    };
                    console.log("data layaut PDF",this.pdfObj)
                    resolve(true);
                } catch (e) {
                    reject(e);
                }
